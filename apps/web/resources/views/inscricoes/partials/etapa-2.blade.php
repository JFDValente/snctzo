<fieldset class="etapa" data-etapa="2">
    ...
    <div class="grupo-campos">
        <div class="campo campo--largo">
            ...
            <p class="campo__ajuda">Selecione uma unidade acadêmica cadastrada ou escolha “Outra unidade acadêmica”.</p>
        </div>
        <div class="campo campo--largo" data-instituicao-nova>
            <label for="instituicao-nome">Nome da unidade acadêmica <span aria-hidden="true">*</span></label>
        ...
        <div class="campo campo--link-instituicao">
            ...
            <p class="campo__ajuda">se for colocar mais de um instagram, separe-os por vírgula. Ex: @snctzo, @uerjzonaoeste</p>
        </div>
        <div class="campo campo--link-instituicao">
